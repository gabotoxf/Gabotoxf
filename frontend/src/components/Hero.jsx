...
export default function Hero() {
    return (
        <section className="min-h-screen flex items-center px-6 sm:px-10 pt-32 lg:pt-28">
                ...
                <div className="col-span-12 lg:col-span-5 flex items-center justify-center">
                    <div className="w-full max-w-[420px] rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md overflow-hidden">
                        ...
                        <div className="p-6 font-mono text-sm space-y-3">
                            ...
                            <p className="pl-4 text-slate-400">enfoque: <span className="text-white">"negocios reales"</span></p>
